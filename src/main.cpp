...
int main() {
    auto context = new OpenGLContext(640, 640, "ZPG - MEC0045");
...
//    auto *cube_model = new Model{"cube", vao_cube, shader_program_rgb};
    ...
    auto vbo_square = new VBO{vertices_square_texture, sizeof(vertices_square_texture)};
    auto ebo_square = new EBO{indices_square, sizeof(indices_square)};
